...
urlpatterns = [
    ...
    path('interacciones/', views.interacciones_view, name='interacciones'),
    path('interacciones/nueva/', views.nueva_interaccion_view, name='nueva_interaccion'),
    path('interacciones/cliente/<int:cliente_id>/', views.interacciones_view, name='interacciones_cliente'),
    path(
    'mi-actividad/',
...
path(
    'usuarios/<int:usuario_id>/eliminar/',
