...
class Migration(migrations.Migration):
    """Adopta las tablas de pedidos existentes sin operaciones de esquema."""
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    options={'db_table': 'core_pedido', 'ordering': ['-creado_en']},
                ),
                migrations.CreateModel(
                    name='DetallePedido',
                    fields=[
                        ...
                        ('producto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='detalles_pedido', to='productos.producto')),
                    ],
                    options={'db_table': 'core_detallepedido', 'verbose_name': 'detalle de pedido', 'verbose_name_plural': 'detalles de pedido'},
                ),
            ],
        ),
    ]
